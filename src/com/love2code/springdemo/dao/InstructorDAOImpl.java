...
public class InstructorDAOImpl implements InstructorDAO {
	...
	public List<Instructor> getInstructores() {
		...
		// obtenemos el listado de instructores ordenados por el primer apellido
				...
				Query<Instructor> theQuery = 
						currentSession.createQuery("from Instructor order by primerApellido",
													Instructor.class);
	...
	public void eliminarInstructor(int elId) {
		...
		// eliminamos de la base de datos el Instructor cuyo id coincida con el parámetro elId
					Query theQuery = 
							currentSession.createQuery("delete from Instructor where id=:instructorId");
	...
	public List<Instructor> buscarInstructores(String theSearchName) {
        ...
        if (theSearchName != null && theSearchName.trim().length() > 0) {
            ...
            theQuery =currentSession.createQuery("from Instructor where lower(nombre) like :elNombre or lower(primerApellido) like :elNombre or lower(segundoApellido) like :elNombre", Instructor.class);
