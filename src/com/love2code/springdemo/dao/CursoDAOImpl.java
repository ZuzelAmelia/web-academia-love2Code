	...
	// inyectamos la session factory
		...
		public List<Curso> getCursos(){
			...
			// obtenemos el listado de cursos ordenados por el titulo
					...
					Query<Curso> theQuery = 
							currentSession.createQuery("from Curso order by titulo",
														Curso.class);
		...
		public void eliminarCurso(int elId) {
			// obtenemos current hibernate session
						...
						// eliminamos de la base de datos el curso cuyo id coincida con el parámetro elId
						Query theQuery = 
								currentSession.createQuery("delete from Curso where id=:cursoId");
