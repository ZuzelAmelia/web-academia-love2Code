...
public class AlumnoController {
	...
	public String guardarAlumno(@Valid @ModelAttribute("alumno") Alumno elAlumno, BindingResult theBindingResult) {
		...
		if (theBindingResult.hasErrors()) {
			...
			// Si no se han producido errores de validación guardamos el alumno usando la
			// capa de servicio alumnoService
	...
	public String mostrarFormForUpdate(@RequestParam("alumnoId") int theId, Model theModel) {
	...
	public String buscarAlumnos(@RequestParam("theSearchName") String theSearchName, Model theModel) {
